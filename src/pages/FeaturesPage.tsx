...
import AuthModal from "./Moadal";
import { useState } from "react";
import RatingFeedbackModal from "./RatingFeedback";
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <GlassCard className="p-6 flex flex-col justify-between">
              ...
              <div onClick={() => handleFeedback()} className="text-primary text-sm font-semibold flex items-center group cursor-pointer w-max">
